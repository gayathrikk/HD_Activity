...
public class HD_Activity {
	...
	WebElement HdElement = wait.until(
	ExpectedConditions.visibilityOfElementLocated(By.xpath("//a[@title='View High Resolution Image']")));
	if (HdElement != null && HdElement.isDisplayed()) {
	HdElement.click();
	System.out.println("HD Resolution Icon clicked successfully");
	} else {
	System.out.println("HD Resolution Icon is not clicked");
	}
	Thread.sleep(7000);
